...
const { email, password, authenticationResponse, submitForm, authenticationLoading } = useAuthentication()
...
<template>
  <div class="bg-gradient-to-b from-lime-100">
    <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="mt-10">
          <div v-if="authenticationResponse" class="bg-red-500 mb-6 text-white font-bold rounded-md py-2 px-4">
            {{ authenticationResponse }}
          </div>
          <div>
            <form @submit.prevent="executeAuthentication" class="space-y-6">
              <div>
  ...
  <div v-if="authenticationLoading"
